...
from langchain.memory import ConversationBufferMemory, FileChatMessageHistory, ConversationSummaryBufferMemory
...
mem = ConversationSummaryBufferMemory(
    ...
    chat_memory=FileChatMessageHistory("messageHistory.json"),
    llm=chat
)
